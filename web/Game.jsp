<%-- 
    Document   : Game
    Created on : Sep 21, 2021, 2:16:32 PM
    Author     : Asus
--%>
...
<html lang="en">
    <head>
        ...
        <%
            ArrayList<GameList> game = (ArrayList<GameList>) request.getAttribute("game");
                                ...
                                <li class="pic-game">
                                    <div class="border-game">
                                        <div class="item-game" style="width: 160px">
                                            <img class="img-game"
                                                 src="<%= g.getPath()%>">
                                            <span style="color: black; font-weight: bold; font-size: 110%;">
                                                <%= g.getName()%>
                                            </span>
                                        </div>
                                        <div style="width: 300px; margin-left: 1rem; text-align: justify;">
                                            <lable style="color:black; font-size: 90%">
                                                <%= g.getDescription()%>
                                            </lable>
                                        </div>
                                    </div>
