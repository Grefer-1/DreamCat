<%-- 
    ...
    Created on : Sep 17, 2021, 2:02:19 PM
    Author     : Asus
--%>

<%@page import="Model.LoginUser"%>
<%@page import="Model.GalleryPic"%>
...
<html lang="en">
    <head>
        ...
        <%
            ArrayList<GalleryPic> gallery = (ArrayList<GalleryPic>) request.getAttribute("gallery");
            ...
            <main class="site-main">
                ...
                <section class="site-content">
                    <div class="gallery-page">
                        <button class="scrollbar-button-increment-img"></button>
                        <button class="scrollbar-button-decrement-img"></button>
                        <div class="hide-scrollbar">
                            <ul class="grid-gallery">
                                <%
                                    for (GalleryPic g : gallery) {
                                %>
