...
public class UpdateProfile extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String id = request.getParameter("idProfile");
            ...
            DreamCatDAO.UpdateProfile(username, password, name, phone, address);
            LoginUser p = DreamCatDAO.getProfileByUsername(username);
            user.clear();
            user.add(p);
